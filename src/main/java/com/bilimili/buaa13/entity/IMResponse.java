...
public class IMResponse {
    private String type;    // 消息类型 如："reply","at_num","up_vote","system_message","message","dynamic" / "error"
    ...
    /**
     * 非系统类消息
     * @param type  消息类型 如："reply","at_num","up_vote","system_message","message","dynamic" 对应 msg_unread 表的每一列
     * @param data  返回的相关数据
