package com.bilimili.backend.service.impl.user;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.bilimili.backend.im.IMServer;
import com.bilimili.backend.mapper.FavoriteMapper;
import com.bilimili.backend.mapper.MsgUnreadMapper;
import com.bilimili.backend.mapper.UserMapper;
import com.bilimili.backend.pojo.*;
import com.bilimili.backend.pojo.dto.UserDTO;
import com.bilimili.backend.service.record.UserRecordService;
import com.bilimili.backend.service.user.UserAccountService;
import com.bilimili.backend.service.user.UserService;
import com.bilimili.backend.service.utils.CurrentUser;
import com.bilimili.backend.utils.ESUtil;
import com.bilimili.backend.utils.JwtUtil;
...
public class UserAccountServiceImpl implements UserAccountService {
    ...
    public CustomResponse register(String username, String password, String confirmedPassword) throws IOException {
        ...
        favoriteMapper.insert(new Favorite(new_user.getUid(), new_user.getUid(), 1, 1, null, "默认收藏夹", "", 0, null));
        favoriteMapper.insert(new Favorite(5000+new_user.getUid(), new_user.getUid(), 1, 1, null, "历史记录", "", 0, null));
